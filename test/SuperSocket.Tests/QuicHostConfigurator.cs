...
namespace SuperSocket.Tests
{
    public class QuicHostConfigurator : IHostConfigurator
    {
        ...
        private IPipelineFilter<TextPackageInfo> GetPipelineFilter()
        {
            ...
            {
                Decoder = new QuicPackageDecoder()
            };
        }

        class QuicPackageDecoder : IPackageDecoder<TextPackageInfo>
        {
            ...
            where TReceivePackage : class
        {
                ...
                CancellationToken cancellationToken)
            {
                ...
                var connection = new StreamPipeConnection(quicStream, quicConnection.RemoteEndPoint,
